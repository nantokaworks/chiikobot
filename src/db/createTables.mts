...
const stmtCounterMessage = await prepare(
  `CREATE TABLE IF NOT EXISTS "counter_message" ("channel_id" text NOT NULL,"threshold" int NOT NULL,"name" text NOT NULL, "message" text NOT NULL, PRIMARY KEY (channel_id, "threshold"));`,
);
