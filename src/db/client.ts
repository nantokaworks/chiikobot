import { dbFile } from '../lib/datafile';
import fs from 'fs';
import sqlite3 from 'sqlite3';
import { channelExists } from './sql/channelExists';
import { createTables } from './sql/createTables';
import { insertChannel } from './sql/insertChannel';
import { TWITCH_ROOT_CHANNEL } from '../lib/env';
import { Channels, getJoinChannels } from './sql/getJoinChannels';
